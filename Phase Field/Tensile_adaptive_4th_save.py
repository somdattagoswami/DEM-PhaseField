...
if __name__ == "__main__":
    ...
    figHeight = 5
    figWidth = 5
    nSteps = 1 # Total number of steps to observe the growth of crack 
    ...
    for iStep in range(0,nSteps):
        ...
        while (keepTraining > 0) and (miter < maxInnerIter):
            ...
            if (len(elem_refine) > 0) and (iStep==0):
                ...
                scipy.io.savemat('../X_f_Tensile_4th.mat', {'X_f': X_f})
            else:
                keepTraining = 0
    ...
    print('Quadrature points saved in X_f_Tensile_4th.mat for Tensile_adaptive_4th_load')